...
function wiz_loginByCookies(cookie, params) {
    ...
    portLoginAjax(loginParam, null, params, wiz_portRequestCategoryAjax);
}
...
//登陆后用户可以选择刷新文件夹目录
function wiz_refreshCategory(port) {
...
function wiz_background_autoLogin(params) {
    Wiz.Cookie.getCookies(Wiz.Constant.Default.COOKIE_URL, Wiz.Constant.Default.COOKIE_CERT, wiz_loginByCookies, true, params);
}
